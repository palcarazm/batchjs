import { AllMatchStream, AllMatchStreamOptions } from "../../../main/streams/index";
describe("AllMatchStream", () => {
    ...
    test("should send false if one not match", (done) => {
    ...
    test("should send true if all match", (done) => {     
        stream.on("end", () => {
